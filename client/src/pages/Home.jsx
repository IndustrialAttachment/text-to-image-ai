    ...
    return (
        <section className='max-w-7xl mx-auto'>
            <div className='justify-center text-center'>
                ...
                <h1 className="mb-4 text-3xl font-extrabold text-gray-900 dark:text-black md:text-5xl lg:text-6xl"><span className="text-transparent bg-clip-text bg-gradient-to-r to-red-600 from-orange-400">Text-to-Image</span> AI Generator.</h1>
